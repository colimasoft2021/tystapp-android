package com.app.tyst.utility.helper.mediahelper
...
import com.app.tyst.utility.extension.getCameraUri
import java.io.*
 ...
 *
 *
 * <provider android:name="android.support.v4.content.FileProvider" android:authorities="com.example.test.provider" android:exported="false" android:grantUriPermissions="true">
...
class MediaHelper {
    ...
    fun file(mimeType: String, callback: Callback) {
        ...
        if (SDK_INT < KITKAT) { //(requestedMimeType != null && requestedMimeType.toLowerCase().contains("image")) || for opening gallery
    ...
    private fun getExtensionFromMimeType(mimeType: String?): String {
        ...
        return if (requestedMimeType!!.toLowerCase().contains("image")) {
