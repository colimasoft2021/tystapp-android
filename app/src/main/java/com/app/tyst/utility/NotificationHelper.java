...
public class NotificationHelper extends ContextWrapper {
    ...
    public void createPhotoViewWithCustumeNotification(String description, String reservation, int reminder, String reservationUniqueNumber) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            nb = getNotificationDefault(getString(R.string.application_name), context.getString(R.string.application_name));
        } else {
            nb = getNotificationDefaultPreO(getString(R.string.application_name), context.getString(R.string.application_name));
        }
